          ...
          {categories.map((subject, index) => (
            <a key={index} href={`/${subject.id}`} >
              <div style={{
                  ...
                  }} className="border rounded-lg border-secondary/20 p-4 flex flex-col gap-2 h-[250px] justify-center items-center hover:!scale-105 hover:!shadow-xl duration-200 cursor-pointer">
                    <img src={subject.image} alt="" className=' h-[180px] w-[100%] object-cover rounded-lg' />
                <p>
                    {subject.name}
                </p>
              </div>
